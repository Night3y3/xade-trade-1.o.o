                    ...
                    return (
                        ...
                        >
                            {(() => {
                                if (!connected) {
                                    return (
                                        <button onClick={openConnectModal} type="button" className='bg-white border-2 border-black text-black rounded-md px-3 py-1 shadow-xl  shadow-black/30 hover:bg-gray-700'>
                                            Connect Wallet
                                        </button>
                                    );
                                }
