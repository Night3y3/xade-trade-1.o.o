export const vaultAbi = [
  ...
  { inputs: [], name: "AccountIdInvalid", type: "error" },
  ...
  { inputs: [], name: "BrokerNotAllowed", type: "error" },
  { inputs: [], name: "EnumerableSetError", type: "error" },
  { inputs: [], name: "NotZeroCodeLength", type: "error" },
  { inputs: [], name: "OnlyCrossChainManagerCanCall", type: "error" },
  { inputs: [], name: "TokenNotAllowed", type: "error" },
  { inputs: [], name: "ZeroCodeLength", type: "error" },
  { inputs: [], name: "ZeroDeposit", type: "error" },
  { inputs: [], name: "ZeroDepositFee", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "address", name: "delegateSigner", type: "address" },
        ],
  ...
  {
    inputs: [{ internalType: "bytes32", name: "_brokerHash", type: "bytes32" }],
  ...
  },
  {
    inputs: [
      {
        components: [
          { internalType: "uint32", name: "dstDomain", type: "uint32" },
          { internalType: "uint64", name: "rebalanceId", type: "uint64" },
          { internalType: "uint128", name: "amount", type: "uint128" },
          { internalType: "bytes32", name: "tokenHash", type: "bytes32" },
          { internalType: "uint256", name: "burnChainId", type: "uint256" },
          { internalType: "uint256", name: "mintChainId", type: "uint256" },
          { internalType: "address", name: "dstVaultAddress", type: "address" },
        ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "burnChainId", type: "uint256" },
          { internalType: "uint256", name: "mintChainId", type: "uint256" },
          { internalType: "bytes", name: "messageBytes", type: "bytes" },
          { internalType: "bytes", name: "messageSignature", type: "bytes" },
        ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_brokerHash", type: "bytes32" },
