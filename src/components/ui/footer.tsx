export default function Footer() {
  return (
    <>
      <footer style={{ padding: "1.5rem 1.25rem" }}>
        <div
          style={{
            display: "flex",
            flexWrap: "wrap",
        ...
        >
          ...
          >
            Xade is completely non-custodial and never takes control over the
            user's funds while transactions are publicly available
          </p>
          <br />
          <p
            style={{
          ...
          >
            <span style={{ fontFamily: "SemiBold", fontSize: "1.2rem" }}>
              CONTACT US
            </span>
            support@xade.finance
          </p>
          <p
            style={{
              textAlign: "left",
          ...
          >
            Unit No. 810, Gold Crest Executive,
          </p>
          <p
            style={{
              textAlign: "left",
          ...
          >
            C2A Jumeriah Lake Towers, Dubai,UAE
          </p>
        </div>
        <br />
        <br />
        ...
        >
          <div>
            <h5 style={{ marginBottom: "0.5rem" }}>Resources</h5>
            <ul
          ...
          <div>
            <h5 style={{ marginBottom: "0.5rem" }}>Community</h5>
            <ul
              style={{ listStyle: "none", padding: "0", marginBottom: "1rem" }}
            >
              <li style={{ marginBottom: "0.5rem" }}>
          ...
          <div>
            <h5 style={{ marginBottom: "0.5rem" }}>Blog</h5>
            <ul
              style={{ listStyle: "none", padding: "0", marginBottom: "1rem" }}
            >
              <li style={{ marginBottom: "0.5rem" }}>
              ...
              <li style={{ marginBottom: "0.5rem" }}>
                <a
                  href="https://xadefinance.medium.com/sabex-lets-beat-inflation-8d8fe9a5e2a1"
                  target="_blank"
                  rel="noreferrer"
                  style={{ textDecoration: "none", color: "inherit" }}
                >
        ...
        >
          ...
          >
            Xade is not an authorised or licensed bank in any jurisdictions nor
            does it have any licenses to provide financial services in any
            jurisdictions.
          </div>
          <div style={{ color: "#808080", fontSize: "0.875rem" }}>
            We are a non custodial platform and we are not liable for any
            actions of our users or any losses incurred on our platform
          </div>
        </div>
      </footer>
      <div
      ...
      >
        <i style={{ fontSize: "2rem", cursor: "pointer" }} aria-hidden="true" />
      </div>
    </>
  );
}
